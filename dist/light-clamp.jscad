...
var ImperialWoodScrews = {
  ...
  '#8': [util.inch(0.332), util.inch(0.100), util.inch(0.164)],
  '#10': [util.inch(0.385), util.inch(0.116), util.inch(0.190)],
...
var Hardware = {
  ...
  Nut: function Nut(nut, fit) {
    return Parts.Hexagon(
      nut[1] + Hardware.Clearances[fit],
      nut[2]
    );
  },
  
  Screw: {
    // PanHead: () => Hardware.ScrewType(Hardware.PanHeadScrew, ),
